<html>
<?php
echo"Keshav Gupta <br/>"; echo" OPERATORS <br/>";
echo"1.Arithmatic Operators <br/>"; echo"variables <br/>";
 $a=20;
$b=10;
 $c=30;
$sum=$a+$b;
$sub=$a-$b;
 ...
 $divi=$a/$b;  
 $mod=$a%$b;
 echo" sum=",$sum."<br/>"; echo" sub=".$sub."<br/>";
echo"multi=".$multi."<br/>";
echo"divi=".$divi."<br/>";  echo"mod=". $mod."<br/>";
echo"2. Increment Operators <br/>"; 
echo" Pre- Increment=".++$a." <br/>";  echo"Post Increment=". $a++."<br/>";
